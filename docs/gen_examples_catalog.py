...
import prefect_soda_cloud

COLLECTION_SLUG = "prefect_soda_cloud"
...
for _, module_name, ispkg in iter_modules(prefect_soda_cloud.__path__):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-soda-cloud`.
            """
        )
    )
